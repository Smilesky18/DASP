...
2. Run code on matrix data. Running the program requires two parameters: matrix path and the choice of verification.

`./spmv_double matrix.mtx 0`

`./spmv_half matrix.mtx 0`
